...
begin
  ...
  insert into public.matches(id,tournament_id,home_team_id,away_team_id,kickoff_at,home_score,away_score,status) values
  (m1,tid,mex,arg,now()-interval '5 days',2,1,'FINISHED'),
  (m2,tid,bra,fra,now()-interval '4 days',0,0,'FINISHED'),
  (m3,tid,ger,esp,now()-interval '3 days',1,3,'FINISHED'),
  (m4,tid,mex,bra,now()+interval '30 seconds',null,null,'SCHEDULED'),
  (m5,tid,arg,esp,now()+interval '2 hours',null,null,'SCHEDULED');

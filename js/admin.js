(function () {
  ...
  function renderMaintenance() {
    return `<section class="card p-5"><h3 class="text-xl font-black">Mantenimiento del torneo</h3>
      ...
      <div class="grid md:grid-cols-2 gap-4 mt-3">
        <article class="prize-place"><h4>Limpiar datos de prueba</h4><p class="text-sm text-slate-700">Limpia todo dato generado por pruebas para dejar el torneo listo para iniciar desde cero.</p><p class="text-sm"><b>Borra:</b> pronósticos, pronósticos especiales, resultados especiales y resultados capturados en partidos.</p><p class="text-sm"><b>Conserva:</b> usuarios/profiles, pagos, roles, torneos, configuración, equipos, partidos y jugadores.</p><button class="btn btn-secondary mt-3" onclick="PronostixAdmin.resetTestData()">Limpiar datos de prueba</button></article>
        <article class="prize-place"><h4>Limpiar resultados</h4><p class="text-sm text-slate-700">Limpia SOLO resultados para volver a simular el torneo sin borrar pronósticos.</p><p class="text-sm"><b>Borra:</b> resultados especiales y resultados capturados en partidos.</p><p class="text-sm"><b>Conserva:</b> pronósticos, pronósticos especiales, usuarios/profiles, pagos, roles, torneos, configuración, equipos, partidos y jugadores.</p><button class="btn btn-secondary mt-3" onclick="PronostixAdmin.resetTournamentResults()">Limpiar resultados</button></article>
      </div>
    </section>`;
  }
